...
const SUBJECTS = [
  "Биология", "Химия", "Физика", "Математика", "Русский язык",
  "История", "Обществознание", "Информатика", "География", "Литература",
...
const SUBJECT_META = {
  ...
  "География":        { emoji: "🌍" },
  "Литература":       { emoji: "📖" },
  "Английский язык":  { emoji: "🇬🇧" },
  "Немецкий язык":    { emoji: "🇩🇪" },
  "Французский язык": { emoji: "🇫🇷" },
  "Испанский язык":   { emoji: "🇪🇸" },
};
